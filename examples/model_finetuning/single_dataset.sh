...
tner-evaluate -m "deberta-v3-large-fin" -e "deberta-v3-large-fin/eval/metric.json" -d "tner/fin" -b 16 --return-ci
tner-evaluate -m "roberta-large-fin" -e "roberta-large-fin/eval/metric.json" -d "tner/fin" -b 32 --return-ci
